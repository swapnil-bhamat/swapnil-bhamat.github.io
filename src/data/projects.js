export const projects = [
  {
    ...
    impact: [
      "Defined service boundaries and contract-driven APIs",
      "Improved developer onboarding and deployment reliability",
      "Established scalable technical foundation"
    ]
  },
  {
    ...
    impact: [
      "Built quantity discounting and delivery estimation systems",
      "Led migration to full-stack TypeScript architecture",
      "Optimized frontend + backend performance (Core Web Vitals)"
    ]
  },
  {
    ...
    impact: [
      "Enabled real-time product customization for enterprise clients",
      "Defined API contracts for platform evolution",
      "Built versioned shared libraries"
    ]
  }
];
